use self::single_byte::SingleByteDecoder;
...
fn get_decoder(charset: &[u8], capacity: usize) -> Option<Box<dyn CharsetDecoder>> {
    let len = charset.len();
    ...
    let mut hash: u32 = len as u32
        + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(0) as usize) }
        + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(1) as usize + 1) }
        + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(len - 1) as usize) };

    if len >= 22 {
        hash =
            hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(21) as usize) };
    }
    if len >= 11 {
        hash = hash
            + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(10) as usize + 1) };
    }
    if len >= 10 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(9) as usize) };
    }
    if len >= 9 {
        hash = hash
            + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(8) as usize + 1) };
    }
    if len >= 8 {
        hash = hash
            + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(7) as usize + 3) };
    }
    if len >= 7 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(6) as usize) };
    }
    if len >= 6 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(5) as usize) };
    }
    if len >= 5 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(4) as usize) };
    }
    if len >= 4 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(3) as usize) };
    }
    if len >= 3 {
        hash = hash + unsafe { charset_hash.get_unchecked(*charset.get_unchecked(2) as usize) };
    }
...
static charset_hash: &'static [u32] = &[
...
mod tests {
    ...
    fn decode() {
        let inputs = [
            ...
            //("iso-8859-6".as_bytes(), b"".to_vec(),""),
            //("iso-8859-6".as_bytes(), b"".to_vec(),""),
            //("iso-8859-6".as_bytes(), b"".to_vec(),""),
            ];

        for input in inputs {
            let mut decoder = get_decoder(input.0, 50).unwrap();
...
/*
    ...
    Keep for future use.
        ...
        // SHIFT_JIS
        2234 if charset == b"shift_jis" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        4294 if charset == b"ms_kanji" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1796 if charset == b"csshiftjis" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // EXTENDED_UNIX_CODE_PACKED_FORMAT_FOR_JAPANESE
        1951 if charset == b"euc-jp" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2835 if charset == b"extended_unix_code_packed_format_for_japanese" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        3555 if charset == b"cseucpkdfmtjapanese" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        ...
        // EUC-KR
        2032 if charset == b"euc-kr" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1508 if charset == b"cseuckr" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // ISO-2022-JP
        2280 if charset == b"iso-2022-jp" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1616 if charset == b"csiso2022jp" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // ISO-2022-JP-2
        ...
        // GBK
        2485 if charset == b"gbk" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1345 if charset == b"cp936" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1105 if charset == b"ms936" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2959 if charset == b"windows-936" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2827 if charset == b"csgbk" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // GB18030
        1332 if charset == b"gb18030" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1334 if charset == b"csgb18030" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // OSD_EBCDIC_DF04_15
        ...
        // UTF-16BE
        2294 if charset == b"utf-16be" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        994 if charset == b"csutf16be" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // UTF-16LE
        2599 if charset == b"utf-16le" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        794 if charset == b"csutf16le" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // UTF-16
        1091 if charset == b"utf-16" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        707 if charset == b"csutf16" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // CESU-8
        ...
        // IBM850
        226 if charset == b"ibm850" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        450 if charset == b"cp850" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        298 if charset == b"850" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2899 if charset == b"cspc850multilingual" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        ...
        // BIG5
        1729 if charset == b"big5" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1041 if charset == b"csbig5" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // MACINTOSH
        2730 if charset == b"macintosh" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        368 if charset == b"mac" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2457 if charset == b"csmacintosh" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // IBM037
        ...
        // KOI8-R
        1032 if charset == b"koi8-r" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        978 if charset == b"cskoi8r" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // HZ-GB-2312
        ...
        // KOI8-U
        1822 if charset == b"koi8-u" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1768 if charset == b"cskoi8u" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // IBM00858
        ...
        // WINDOWS-1250
        2302 if charset == b"windows-1250" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1763 if charset == b"cswindows1250" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1251
        2252 if charset == b"windows-1251" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1713 if charset == b"cswindows1251" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1252
        2247 if charset == b"windows-1252" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1708 if charset == b"cswindows1252" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1253
        2682 if charset == b"windows-1253" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        2143 if charset == b"cswindows1253" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1254
        2282 if charset == b"windows-1254" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1743 if charset == b"cswindows1254" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1255
        2267 if charset == b"windows-1255" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1728 if charset == b"cswindows1255" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1256
        2392 if charset == b"windows-1256" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1853 if charset == b"cswindows1256" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1257
        2437 if charset == b"windows-1257" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1898 if charset == b"cswindows1257" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // WINDOWS-1258
        2317 if charset == b"windows-1258" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1778 if charset == b"cswindows1258" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // TIS-620
        1012 if charset == b"tis-620" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        703 if charset == b"cstis620" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        1400 if charset == b"iso-8859-11" => Some(Box::new(SingleByteDecoder::new(SingleByteDecoder::ISO_8859_2, capacity))),
        // CP50220
